...
st.set_page_config(
    page_title="QORGAN AI — интернет-алаяқтық хабарламаларын анықтау",
    page_icon="🛡️",
    layout="wide",
...
st.markdown(
    """
**QORGAN AI (Қорған AI)** — қазақ және қазақ-орыс аралас тілдеріндегі
интернет-алаяқтық, фишинг және күмәнді хабарламаларды машиналық оқыту
әдістерімен автоматты анықтауға арналған интеллектуалды веб-платформа.

Платформа SMS, WhatsApp және Telegram хабарламаларын мәтін немесе
скриншот арқылы талдап, алаяқтық ықтималдығы мен қауіп деңгейін көрсетеді.
"""
)
